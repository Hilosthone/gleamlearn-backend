...
@Module({
  imports: [
    ...
    // - 'short': Max 3 requests per 1 second window
    // - 'long': Max 60 requests per 60 second window
  ...
  providers: [
    ...
    {
      provide: APP_GUARD,
      useClass: ThrottlerGuard, // Applies global rate limiting protection across all controllers
    },
  ],
})
export class AppModule {}