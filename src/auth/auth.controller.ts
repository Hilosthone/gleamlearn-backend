...
import { EmailDto } from './dto/email.dto.js';
import { ResetPasswordDto, ChangePasswordDto, UpdateUserDto } from './dto/password.dto.js';
import { JwtAuthGuard } from './guards/jwt-auth.guard.js'; // Adjust path if needed
import { CurrentUser } from './decorators/current-user.decorator.js'; // Adjust path if needed
